...
impl Flam3Variation for variations::Oscilloscope {
    fn apply(
        ...
        let t = if self.damping == 0.0 {
            ...
            self.amplitude * (-f.tx.abs() * self.damping).exp() * cos!(tpf * f.tx) + self.separation
        };
...
impl Flam3Variation for variations::Sec {
    fn apply(
        ...
        let secden = 2.0 / (cos!(2.0 * f.tx) + (2.0 * f.ty).cosh());
...
impl Flam3Variation for variations::Csc {
    fn apply(
        ...
        let cscden = 2.0 / ((2.0 * f.ty).cosh() - cos!(2.0 * f.tx));
...
impl Flam3Variation for variations::Sech {
    fn apply(
        ...
        let sechden = 2.0 / (cos!(2.0 * f.ty) + (2.0 * f.tx).cosh());
...
impl Flam3Variation for variations::Csch {
    fn apply(
        ...
        let cschden = 2.0 / ((2.0 * f.tx).cosh() - cos!(2.0 * f.ty));
